    ...
    return (
        <Background>
            ...
            {tasks.length == 0 && (
                ...
                <View style={{flexDirection:'column', height:'74%', width:'100%', alignItems:'center', justifyContent:'center', opacity:0.6}}>
                    <Image
                        source={require("./images/sleepbee.png")}
                        style={styles.addbtn}
                    />
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={{flexDirection:"column"}}>
                                <TouchableOpacity onPress={() => gotoChat(item.project_id, item.projectName, item.projectDescription)}>
