           ...
           <ScrollView>
               <View style={{ padding: 15, marginTop: 80 }}>
                   ...
                   <View style={styles.TaskItem2}>
                       <Text style={styles.texthere}>Start: {formatDate(task.timeStart)}</Text>
                       <Text style={styles.texthere}>End: {formatDate(task.timeEnd)}</Text>
                       <Text style={styles.texthere}>Deadline: {formatDate(task.deadline)}</Text>
                       <View>
                           <Text style={styles.texthere}>Person in charge: </Text>
                           {users.map(user => (
                   ...
                   <View style={styles.commentt}>
                        <View style={styles.commentview}></View>
