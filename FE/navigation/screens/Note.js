                ...
                <View>
                    <TouchableOpacity onPress={() => setAddNoteModalVisible(true)}>
                        <View style={styles.addButton}>
                            <Text style={{fontSize:16, color:'#FFFFFF'}}>ADD NOTE</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                {notes.length == 0 && (

                       <View style={{flexDirection:'column', height:'90%', width:'100%', alignItems:'center', justifyContent:'center', opacity:0.6}}>
                           <Image
